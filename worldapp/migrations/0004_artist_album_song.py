...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('worldapp', '0003_delete_worldborder'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='worldapp.artist', verbose_name='Artist Album')),
            ],
            options={
                'verbose_name': 'Album',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='worldapp.album', verbose_name='Song Album')),
            ],
            options={
                'verbose_name': 'Song',
