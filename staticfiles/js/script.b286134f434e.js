...
function favouritePub(pubId) {
    // Get the user's ID
    let userId = getCookie('userId');  // Assuming you have a function getCookie to get the user's ID

    fetch(`/favourite_pub/`, {  // Assuming you have a Django view at this URL that handles the request
        method: 'POST',
        headers: {
        ...
        body: JSON.stringify({ userId: userId, pubId: pubId })  // Send the user's ID and the pub's ID in the request body
    })
...
function addMarkersToMap(data) {
    L.geoJson(data, {
        ...
        onEachFeature: function (feature, layer) {
            ...
            // Add "Favourite" button to the popup content
            pubContent += `<button onclick="favouritePub('${feature.properties['@id']}')">Favourite Pub</button>`;
