...
// Function to add all markers back to the map
            ...
            onEachFeature: function (feature, layer) {
                ...
                layer.on('click', function () {
                    if (gpsMarker) {
                        ...
                        // Add a button to the popup to close the view
                        let closeButton = L.DomUtil.create('button', 'close-button');
                        closeButton.innerHTML = 'Close View';
                        closeButton.onclick = function () {
                            removeRoute();
                            addAllMarkers();
                        };
                        layer.getPopup().getContentNode().appendChild(closeButton);
                    }
                });
            },
        }).addTo(map);
...
const overlayMaps = {
    "Pubs": L.layerGroup(markers) // Convert markers array to a layer group
};
