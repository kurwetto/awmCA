...
const displayUserFavoritedPubsButton = document.getElementById('displayUserFavoritedPubsButton'); // Replace 'displayFavoritedPubsButton' with the ID of your button
displayUserFavoritedPubsButton.addEventListener('click', displayUserFavoritedPubsButton);
...
favoritePubsButton.addEventListener('click', function() {
    ...
    fetch('/user_favorited_pubs/')  // Replace '/user_favorited_pubs/' with the actual endpoint URL
        ...
        .then(function (data) {
            ...
            // Update matchingPubs to only include the pubs that the user has favorited
            matchingPubs = markers.filter(marker => data.includes(marker.feature.properties.name.toLowerCase()));
            ...
            for (var i = 0; i < markers.length; i++) {
                ...
                // If the pub name is in the user's favorited pubs, show the marker
                if (data.includes(pubName)) {
                    marker.addTo(map);
                }
