...
window.onSpotifyWebPlaybackSDKReady = () => {
  const token = 'BQC1xSPshsbN2VKj0oa1bv1QI5HjAkNE_YWwto2V0hxtWtOiypCHMv8kkMKmRZ6O1sdOnxVDGEavpkm2KYZFLrQVLoczjx7Ft8g1ezSlVby6s9JXz0SXyUWn6VxmI4jYdVhURAJ1z8ah2sG9mrFBLpxb76q6U-pnfnNOtwQVKOzYeQlR9CdK6-fs9iIpWDpOGcObTtL_uBXEJEJK0kZPKCmLI8BQ';  // Replace with your Spotify access token
  const player = new Spotify.Player({
    name: 'FYP Musivents Player',
