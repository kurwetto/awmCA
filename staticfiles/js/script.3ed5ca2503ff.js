...
fetch('/static/fuel_location.geojson')
    ...
    .then(function (data) {
        L.geoJson(data, {
            ...
            onEachFeature: function (feature, layer) {
                ...
                // Add a "Directions" button to the popup content
                pubContent += '<button id="directions-button">Directions</button>';
                ...
                // Add click event to the "Directions" button instead
    ...
    routeWhileDragging: true,
    show: false, // Don't show the control by default
    className: 'my-routing-control' // Add a custom class
}).addTo(map);
            },
        }).addTo(map);
    });
