...
function toggleAudio() {
    if (audio.paused) {
        audio.play();
        document.getElementById('togglePlay').innerText = 'Pause Music';
    } else {
        audio.pause();
        document.getElementById('togglePlay').innerText = 'Play Music';
    }
}
        ...
        L.geoJson(data, {
            ...
            onEachFeature: function (feature, layer) {
                ...
                if (feature.properties.songURL) {
                    pubContent += "<p>SongURL: " + feature.properties.songURL + "</p>";
                }
                ...
                if (feature.properties.songURL) {
                    layer.on('click', function () {
                        ...
                        audio = new Audio(feature.properties.songURL);
                        audio.play();
                        document.getElementById('togglePlay').innerText = 'Pause Music';
                    });
                }
